...
var NorenRestApi = function(params) {
    var self = this;
    self.__susertoken = "481ce7ab4add437d222f6efd3e375fd2b1779c3dd2686d";
    self.__username = "FA305572"
    self.__accountid = "FA305572"
    ...
    self.start_websocket = function(callbacks) {
        ...
        web_socket.connect(params, callbacks)
            .then(() => {
                console.log('Web_Socket is connected');
            });
    };
    ...
    self.get_security = function(exchange, contractToken) {

        let values = {};
        values["uid"] = self.__username;
        values["actid"] = self.__accountid;
        values["exch"] = exchange;
        values["token"] = contractToken;
